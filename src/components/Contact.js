...
// ta strona zawiera komponent formularza kontaktowego. obecnie nie jest on umieszczony nigdzie na stronie i wymaga to konsultacji z odbiorcą projektu

const navigation = {
    social: [
        // sekcja poświęcona linkom do serwisów społecznościowych. Jeżeli firma ZTB takie założy, tutaj należy odkomentować odpowiedni serwis i podać link do strony
...
const Contact = ({ heading, imageAlt, additionalClass }) => (
